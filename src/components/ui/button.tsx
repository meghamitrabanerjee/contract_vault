  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Professional Contract Vault variants
        hero: "bg-gradient-primary text-primary-foreground hover:opacity-90 shadow-soft border-0 font-semibold",
        accent: "bg-gradient-accent text-accent-foreground hover:opacity-90 shadow-soft border-0 font-semibold",
        premium: "bg-background text-foreground border-2 border-primary hover:bg-primary-light hover:border-primary/80 shadow-soft font-medium",
        minimal: "bg-muted text-muted-foreground hover:bg-muted/80 hover:text-foreground border-0 shadow-elegant",
